const es = {
  ...
  agentTest: {
    ...
    "step.comprehension": "Comprensión del negocio",
    "step.structured_data": "Datos estructurados",
    // Comprehension details
    "comprehension.pass": "El agente entendió: {description}",
    "comprehension.partial": "El agente identificó parcialmente el negocio: {description}",
    "comprehension.fail": "El agente no pudo determinar a qué se dedica el negocio a partir del contenido visible.",
    "rec.comprehension.fail": "Añade textos descriptivos claros en la home y páginas principales: qué servicios ofreces, a quién te diriges, dónde estás. Los agentes IA necesitan texto legible, no imágenes ni animaciones.",
    // Comprehension substeps
    "substep.servicesDetected": "Servicios detectados",
    "substep.servicesDetectedList": "{list}",
    "substep.servicesNone": "No se pudieron identificar servicios",
    "substep.location": "Ubicación",
    "substep.locationFound": "{cities}",
    "substep.locationNone": "No identificada",
    "substep.audience": "Público objetivo",
    "substep.audienceFound": "{list}",
    "substep.audienceNone": "No identificado",
    "substep.pricing": "Precios",
    "substep.pricingFound": "{prices}",
    "substep.pricingNone": "No visibles en la web",
    "substep.keyHeadings": "Titulares clave",
    ...
    "substep.formOpaqueFields": "{opaque} de {total} campos no tienen etiquetas comprensibles — un agente IA no sabe qué rellenar",
    ...
    "comparison.title": "Comparativa: {target} vs {competitor}",
    "comparison.subtitle": "Le pedimos al mismo agente IA la misma tarea en ambas webs. Estos son los resultados.",
    "comparison.targetLabel": "Tu web",
    "comparison.competitorLabel": "Competidor",
    "comparison.verdictBetter": "Tu web supera al competidor en este aspecto.",
    "comparison.verdictWorse": "El competidor lo hace mejor. Tus clientes potenciales podrían acabar allí.",
    "comparison.verdictEqual": "Ambas webs tienen un rendimiento similar.",
    "comparison.summaryTitle": "Resumen",
    "comparison.summaryWinning": "{target} gana en {count} de {total} pasos.",
    "comparison.summaryLosing": "{competitor} gana en {count} de {total} pasos.",
    "comparison.summaryTied": "Empate en {count} de {total} pasos.",
    "comparison.warningTitle": "El riesgo real",
    "comparison.warningBody": "Cuando un agente IA no puede completar una tarea en tu web pero sí en la del competidor, el cliente se va al competidor. Esto ya está pasando.",
  } as Record<string, string>,
  footer: {

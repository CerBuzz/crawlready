const es = {
  ...
  agentTest: {
    ...
    "verdict.pass": "El agente completó la tarea con éxito",
    "verdict.partial": "El agente no pudo completar la tarea",
    "verdict.fail": "El agente no pudo interactuar con tu web",
    "verdict.pass.detail": "Un agente IA pudo encontrar tus servicios y contactar contigo.",
    "verdict.partial.detail": "Existen canales de contacto, pero hay barreras que impiden completar la acción.",
    "verdict.fail.detail": "No se encontró ninguna vía para que un agente IA contacte o contrate tus servicios.",
    passed: "Aprobados",
    partial: "Parciales",
    failed: "Fallidos",
